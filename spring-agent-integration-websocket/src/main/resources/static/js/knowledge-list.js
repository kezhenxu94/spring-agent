...
function row(entry, options) {
  ...
  // tall as the thing it lists. The detail panel still carries it, which is where somebody asking
  // when this arrived is looking. A row is one line, the same as a conversation's.
