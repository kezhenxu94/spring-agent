 ...
 * </ul>
 */
class CoreToolTranslationsCompleteTest {
  ...
  static void inventory() throws Exception {
    english =
        ToolTextsInventory.englishOf(
            "me.kezhenxu94.springagent.core",
            me.kezhenxu94.springagent.core.aot.AgentToolsRuntimeHints.TOOL_TYPES);
    texts =
        new ModuleToolTexts(
            "core/tools",
            me.kezhenxu94.springagent.core.config.LocalizedPrompt.TOOLS_LOCATION,
            Locale.of("zh", "CN"));
  }
