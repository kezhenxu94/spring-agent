package me.kezhenxu94.springagent.core.jobs;
 ...
 * the field, so {@link me.kezhenxu94.springagent.core.tools.McpClientFactory} doesn't need to guess
 * a default at read time forever. {@code title}, {@code description} and {@code websiteUrl} are
 * left untouched — they have no prior implicit value worth backfilling.
 */
@Slf4j
@Component
