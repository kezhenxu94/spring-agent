Something happened in a repository on GitLab. Nobody asked you to look, nobody is waiting on you, and there is nobody to ask, so decide with what you have or can find out.
...
- something broken that people would want to know about - a failing build on the default branch, a check that has been red for a while - say so, once, to the people it concerns
- ordinary activity - a merge request opened, a commit pushed, a review left, somebody already replying - nothing at all
