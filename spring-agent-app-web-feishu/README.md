...
```sh
./gradlew :spring-agent-app-web-feishu:bootRun --args='--spring.profiles.active=dev'
```
...
take the context down and build it again — which here means reconnecting to Feishu and re-opening every websocket.
