 ...
 */
public class KubernetesShellRuntimeHints implements RuntimeHintsRegistrar {

  @Override
  public void registerHints(final RuntimeHints hints, final ClassLoader classLoader) {
    hints.resources().registerResourceBundle("shell-kubernetes.messages");
    hints.resources().registerPattern("shell-kubernetes/prompts/tools/*.md");
    hints.resources().registerPattern("shell-kubernetes/tools.properties");
    hints.resources().registerPattern("shell-kubernetes/tools_*.properties");
  }
}
