...
class ShellBackendSelectionTest {
  ...
  private final ApplicationContextRunner runner =
      new ApplicationContextRunner()
          ...
          // What the credential tools answer with. A @Component of core's, so a runner that
          // assembles only the shell auto-configurations has to supply it.
          .withBean(CoreMessages.class, () -> mock(CoreMessages.class))
