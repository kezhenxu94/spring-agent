 ...
 * the second is an intersection of two Redis sets. {@code updateStatus} cannot — Spring Data Redis
 * has no annotation for a partial update the way JPA and MongoDB do — and comes from {@link
 * ScheduledTaskStatusUpdate}.
 */
public interface RedisScheduledTaskRepo
    extends ScheduledTaskRepo, ScheduledTaskStatusUpdate, CrudRepository<ScheduledTask, String> {}
