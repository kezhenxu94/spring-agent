 ...
 * the second is an intersection of two Redis sets. The partial writes — {@code updateStatus},
 * {@code updateTaskText} and {@code incrementRunCount} — cannot, since Spring Data Redis has no
 * annotation for a partial update the way JPA and MongoDB do, and come from {@link
 * ScheduledTaskPartialUpdate}.
 */
