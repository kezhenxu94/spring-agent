...
class ScheduledTaskFiringEventTest {
  ...
  void toolContextIsCollected() {
    ...
    assertThat(event.toolContext())
        .containsExactly(java.util.Map.entry("cardUpdater", "the-updater"));
  }

  private static final class RecordingListener
      implements me.kezhenxu94.springagent.agent.AgentResponseListener {
    @Override
    public void onContent(String contentSoFar) {}

    @Override
    public void onUsage(String model, org.springframework.ai.chat.metadata.Usage usage) {}
